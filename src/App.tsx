...
export default function App() {
  ...
  const [shipments, setShipments] = useState<Shipment[]>([
    ...
    },
    {
      ...
      routeChangeEvent: {
        type: 'manual',
        initialCarrierServiceType: 'USPS First-Class Package International',
        newCarrierServiceType: 'USPS Priority Mail International',
        triggeredBy: 'Jamie Chen',
        occurredAtLabel: '6/10/2026 11:30 AM',
      },
    },
    {
      orderId: '273133184',
    ...
    },
    {
      ...
      consolidatedPack: 2,
      appliedRuleIds: ['rule_2'],
      carrierServiceType: 'DHL Economy Select',
      estimatedDeliveryDate: '2026-06-24',
      orderEta: '2026-06-22',
      routeChangeEvent: {
        type: 'auto-downgrade',
        initialCarrierServiceType: 'DHL Express Worldwide',
        initialEta: '2026-06-21',
        newCarrierServiceType: 'DHL Economy Select',
        newEta: '2026-06-24',
        triggeredBy: 'EU downgrade — economy lane',
        occurredAtLabel: '6/11/2026 8:15 AM',
      },
    },
    {
      orderId: '273133186',
    ...
    },
    {
      ...
      status: 'Shipped',
      appliedRuleIds: ['rule_1'],
      carrierServiceType: 'UPS Worldwide Saver',
      estimatedDeliveryDate: '2026-06-22',
      orderEta: '2026-06-23',
      routeChangeEvent: {
        type: 'auto-upgrade',
        initialCarrierServiceType: 'UPS Ground',
        initialEta: '2026-06-27',
        newCarrierServiceType: 'UPS Worldwide Saver',
        newEta: '2026-06-22',
        triggeredBy: 'Standard upgrade — US Rings',
        occurredAtLabel: '6/11/2026 8:20 AM',
      },
    },
    {
      orderId: '273133188',
    ...
    },
    {
      ...
      routeChangeEvent: {
        type: 'auto-upgrade',
        initialCarrierServiceType: 'FedEx International Economy',
        initialEta: '2026-06-25',
        newCarrierServiceType: 'FedEx International Priority',
        newEta: '2026-06-20',
        triggeredBy: 'Standard upgrade — US Rings',
        occurredAtLabel: '6/11/2026 8:20 AM',
      },
