...
const MOCK_ROWS: PackingInstructionRow[] = [
  {
    ...
    contentHe: 'טפל בזהירות.',
    contentAr: 'تعامل بحذر.',
    contentHu: 'Kezelje óvatosan.',
    contentTh: 'จัดการด้วยความระมัดระวัง.',
  },
  {
    id: 'pi-2',
    ...
    contentHe: 'אמת ביטוח.',
    contentAr: 'تحقق من التأمين.',
    contentHu: 'Ellenőrizze a biztosítást.',
    contentTh: 'ตรวจสอบประกันภัย.',
  },
  {
    id: 'pi-3',
    ...
    contentHe: 'השתמש בכיס קטן.',
    contentAr: 'استخدم كيساً صغيراً.',
    contentHu: 'Használjon kis tasakot.',
    contentTh: 'ใช้ถุงเล็ก.',
  },
  {
    id: 'pi-4',
    ...
    contentHe: 'נדרש אישור מנהל.',
    contentAr: 'مطلوب موافقة المدير.',
    contentHu: 'Vezetői jóváhagyás szükséges.',
    contentTh: 'ต้องได้รับการอนุมัติจากผู้จัดการ.',
  },
];
