...
const MOCK_ALERT_ROWS: Omit<ShipmentAlertRow, 'lastUpdated'>[] = [
  {
    ...
    activationLogic: '[shipment_status IS not_packed] AND [hours_in_status GREATER THAN 0]',
  ...
  },
  {
    ...
    activationLogic: '[shipment_status IS not_packed] AND [hours_in_status GREATER THAN 12]',
    releaseLogic: { kind: 'manual' },
    status: 'Live',
  },
  {
    ...
    activationLogic: '[shipment_status IS draft] AND [hours_in_status GREATER THAN 12]',
  ...
  },
  {
    ...
    activationLogic: '[shipment_status IS ready_to_pack] AND [hours_in_status GREATER THAN 6]',
    releaseLogic: { kind: 'manual' },
    status: 'Live',
  },
  {
    ...
    activationLogic: '[label_status IS pending] AND [hours_in_status GREATER THAN 24]',
  ...
  },
  {
    ...
    activationLogic: '[shipment_status IS packed] AND [pickup_scheduled IS false]',
    releaseLogic: { kind: 'manual' },
    status: 'Live',
  },
  {
    ...
    activationLogic: '[customs_status IS hold] AND [destination_region IS international]',
    releaseLogic: { kind: 'status', value: 'Ready to Pack' },
    status: 'Draft',
  },
  {
    ...
    activationLogic: '[declared_value GREATER THAN 5000] AND [review_status IS pending]',
